        ...
        <v-simple-table class="tableAll">
            <template v-slot:default>
                ...
                <tr v-for="(itemField, id) in committee"  class="tr_row" :key="`committeeItem${id}`">
                    ...
                    <td v-if="$t('lang') === 'ru'" class="td_block text-left">{{ itemField.name_ru}}</td>
                    <td v-if="$t('lang') === 'en'" class="td_block text-left">{{ itemField.name_en}} </td>
                    <td v-if="$t('lang') === 'ru'" class="td_block text-left">{{ itemField.position_ru}}</td>
                    <td v-if="$t('lang') === 'en'" class="td_block text-left">{{ itemField.position_en}}</td>
                    <td v-if="$t('lang') === 'ru'" class="td_block text-left">{{ itemField.state_ru }}</td>
                    <td v-if="$t('lang') === 'en'" class="td_block text-left">{{ itemField.state_en }}</td>
                </tr>
                </tbody>
            </template>
        </v-simple-table>
