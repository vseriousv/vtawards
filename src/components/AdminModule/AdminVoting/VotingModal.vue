    ...
    export default {
        ...
        methods: {
            sendData: function () {
                ...
                if( this.$store.state.votingYear === '' || this.$store.state.votingType === ''|| this.$store.state.votingStatus === ''){
        ...
        computed: {
            votingId: {
                get () {  return this.$store.state.votingId;  },
                set (id) { this.$store.commit("setVotingId", id); }
            },
            votingYear: {
                get () { return this.$store.state.votingYear; },
                set (value) { this.$store.commit("setVotingYear", value); }
            },
            votingType: {
                get () { return this.$store.state.votingType; },
                set (value) { this.$store.commit("setVotingType", value); }
            },
            votingStatus: {
                get () { return this.$store.state.votingStatus; },
                set (value) { this.$store.commit("setVotingStatus", value); }
            },
            adminErrorStr: {
