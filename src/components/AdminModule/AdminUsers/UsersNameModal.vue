...
<script>
    export default {
        ...
        computed: {
            adminUser_email: {
                get () {  return this.$store.state.adminUser_email;  },
                set (id) { this.$store.commit("setAdminUser_email", id); }
            },
            adminUser_tab_number: {
                get () {  return this.$store.state.adminUser_tab_number;  },
                set (id) { this.$store.commit("setAdminUser_tab_number", id); }
            },
            adminUser_firstname_ru: {
                get () {  return this.$store.state.adminUser_firstname_ru;  },
                set (id) { this.$store.commit("setAdminUser_firstname_ru", id); }
            },
            adminUser_firstname_en: {
                get () {  return this.$store.state.adminUser_firstname_en;  },
                set (id) { this.$store.commit("setAdminUser_firstname_en", id); }
            },
            adminUser_lastname_ru: {
                get () {  return this.$store.state.adminUser_lastname_ru;  },
                set (id) { this.$store.commit("setAdminUser_lastname_ru", id); }
            },
            adminUser_lastname_en: {
                get () {  return this.$store.state.adminUser_lastname_en;  },
                set (id) { this.$store.commit("setAdminUser_lastname_en", id); }
            },
            adminUser_patronymic_ru: {
                get () {  return this.$store.state.adminUser_patronymic_ru;  },
                set (id) { this.$store.commit("setAdminUser_patronymic_ru", id); }
            },
            adminUser_patronymic_en: {
                get () {  return this.$store.state.adminUser_patronymic_en;  },
                set (id) { this.$store.commit("setAdminUser_patronymic_en", id); }
            },
