...
export default {
  ...
  computed: {
    adminUser_description_ru: {
      get() {
        return this.$store.state.adminUser_description_ru;
      },
      set(value) {
        this.$store.commit("setAdminUser_description_ru", value);
      }
    },
    adminUser_description_en: {
      get() {
        return this.$store.state.adminUser_description_en;
      },
      set(value) {
        this.$store.commit("setAdminUser_description_en", value);
      }
    },
