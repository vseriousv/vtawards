						...
						<div class="userData__box">
							...
							<v-list>
								<v-list-item class="userData__item mb-2">
									<p class="mb-0">
										Пароль пользователя: {{ userID.userPassword }}
									</p>
								</v-list-item>
								...
								<v-list-item class="userData__item mb-1">
									...
									<div class="userData__btn">
										...
										<v-btn
											...
											color="primary"
											@click.stop="
												saveDataInput(1, { stateId: userID.stateId })
											"
										>
											Сохранить
										</v-btn>
								...
								<v-list-item class="userData__item mb-2">
									...
									<div class="userData__btn">
										...
										<v-btn
											...
											color="primary"
											@click.stop="
												saveDataInput(3, { stateId: userID.stateId })
											"
										>
											Сохранить
										</v-btn>
...
export default {
	...
	methods: {
		...
		postNewDataInput: async function(data) {
			...
			try {
				const postNewDataInput = await axios.patch(config.API_URL + url, data, {
					headers: {
