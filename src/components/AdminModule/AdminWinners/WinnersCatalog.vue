    ...
    export default {
        ...
        methods: {
            ...
            updateWinnersID: function (id) {
                ...
                this.$store.commit("setWinnerId", this.winners.find(item=>item.id === id).id);
                this.$store.commit("setWinnerUser_Id", this.winners.find(item=>item.id === id).user_id);
                this.$store.commit("setWinnerVotingId", this.winners.find(item=>item.id === id).voting_id);
