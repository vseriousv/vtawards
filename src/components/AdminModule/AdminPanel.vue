			...
			<div class="contentPanel d-md-none">
				<v-menu transition="slide-x-transition" bottom right>
					...
					<v-list class="listCog d-flex flex-column">
						<router-link class="listCog__item" to="/admin/general"
							>Админка</router-link
						>
						<router-link class="listCog__item" to="/admin/applications"
							>Управление заявками</router-link
						>
						<router-link class="listCog__item" to="/admin/users"
...
export default {
	name: "AdminPanel",
	props: ["adminTrue", "dnone"],
	created() {
		this.$emit("checkAdminPanel");
	}
};
</script>
